...
/**
 * The MXEFMetaboxesGenerator class.
 *
 * This Class helps add Metaboxes to any CPT.
 */
class MXEFMetaboxesGenerator
{
    ...
    public function __construct($args)
    {
        ...
        $this->defaults = [
            ...
            'name'         => esc_html__('Extra metabox 1', 'ewd-faq'),
            'metabox_type' => 'text',
            'options'      => [],
        ...
        <div>
            ...
            <?php elseif ($this->args['metabox_type'] == 'image') : ?>
                ...
                <div class="mx-image-uploader">
                    ...
                    <button class="mxef_upload_image" <?php echo $image_url !== '' ? 'style="display: none;"' : ''; ?>>Choose image</button>

                    <!-- Save an image id. -->
                    <input name="<?php echo esc_attr($this->args['post_meta_key']); ?>" id="<?php echo esc_attr($this->args['post_meta_key']); ?>" type="hidden" class="mxef_upload_image_save" value="<?php echo esc_html($metaValue); ?>" />

                    <!-- Show an image. -->
                    <img src="<?php echo $image_url !== '' ? esc_url($image_url) : ''; ?>" style="width: 300px;" alt="" class="mxef_upload_image_show" <?php echo $image_url == '' ? 'style="display: none;"' : ''; ?> />

                    <!-- Remove image. -->
                    <a href="#" class="mxef_upload_image_remove" <?php echo $image_url == '' ? 'style="display: none;"' : ''; ?>>Remove Image</a>
